...
\input{sections/s3_cases}
\input{sections/s4_chaos}
\input{sections/s5_fprm}
\input{sections/s6_results}
\input{sections/s7_lab}
\input{sections/s8_discussion}
\input{sections/s9_conclusions}
...
\ifx\zenodoDOI\empty
The code and data that regenerate every figure and number (the \texttt{piar} package, the experiment and figure scripts, the unit tests, the interactive notebook, the browser-based simulation, and the numerical results) will be openly available in Zenodo upon publication.
\else
The code and data that regenerate every figure and number (the \texttt{piar} package, the experiment and figure scripts, the unit tests, the interactive notebook, the browser-based simulation, and the numerical results) are openly available in Zenodo at \url{https://doi.org/\zenodoDOI}.
\fi

\appendix
\input{sections/app_derivations}
\input{sections/app_hyper}
